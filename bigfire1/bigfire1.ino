...
//
//
//dataBase  dataBase( WIFI_SSID , WIFI_PASSWORD ,  FIREBASE_AUTH , FIREBASE_HOST )  ; 
//
//void setup() 
//{ 
//  Serial.begin(115200) ; 
//  if ( dataBase.connectWifi() == true ) 
//  {
...
String path1 = "/BigFire/box/box1/";
String path2 = "BigFire/box/box2/" ;
String path3 = "BigFire/box/box2/status" ;
void loop()
{
  //" \"{""\"value\""":1}\""
  pushData( path1 , "ben dep trai" ) ;
  delay(1000) ;
  SETData( path3 , 1 ) ; 
  getData ( path2 ) ;
  delay(1000) ;
  updateData( path2  , "ben dep trai" ) ;
}
